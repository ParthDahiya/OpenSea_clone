...
const style ={
    wrapper: 'relative flex h-[450px] w-[340px] cursor-pointer flex-col rounded-lg:bg-white border rounded-lg border-neutral-300 shadow-lg transition-all duration-300 hover:shadow-2xl dark:bg-[#333333]',
    ...
    nftInfoCoontainer: 'flex justify-between',
    collectionTitle: 'text-sm text-gray-500 dark:text-gray-500',
    ...
    likesContainer: 'flex itmes-center justify-end space-x-2',
    ...
    return (
        <div className={style.wrapper}>
            ...
            <div className={style.nftLowerContainer}>
                <div className={style.nftInfoCoontainer}>
                    <div>
                    ...
                    <div className={style.priceContainer}>
                        <div className={style.priceTitle}></div>
